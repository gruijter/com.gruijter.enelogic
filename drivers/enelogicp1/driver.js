...
//  Homey.log(util.inspect(device_data, false, 10, true));
  ...
  //app is initializing or data is corrupt
  if (safeRead(device_data, 'readings.e') == undefined ){
    return
  };
...
// electricity readings from device
  ...
  electricity_point_meter_consumed = Number(safeRead(device_data,'readings.e.4._'))*1000; //electricity_point_meter_consumed
  electricity_cumulative_meter_offpeak_produced = Number(safeRead(device_data,'readings.e.2._')) ; //electricity_cumulative_meter_offpeak_produced
  electricity_cumulative_meter_peak_produced = Number(safeRead(device_data,'readings.e.3._')) ; //electricity_cumulative_meter_peak_produced
  electricity_cumulative_meter_offpeak_consumed = Number(safeRead(device_data,'readings.e.0._')) ; //electricity_cumulative_meter_offpeak_consumed
  electricity_cumulative_meter_peak_consumed = Number(safeRead(device_data,'readings.e.1._')) ; //electricity_cumulative_meter_peak_consumed
